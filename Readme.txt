...
Some projects completed so far...

  In C++:
  - MultiplicationTable -> Generates a multiplication Table based off user input
...
In progress...
  ...
  In Python:
  - BlackJackGame -> working on creating a black jack game on terminal
